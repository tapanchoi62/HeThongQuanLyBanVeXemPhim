 ...
 * @author ~Midori Mato~
 */
public class FormTracuumave extends javax.swing.JFrame {

    /**
     * Creates new form FormTracuumave
     */
    public FormTracuumave() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTracuumave.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormTracuumave().setVisible(true);
            }
        });
    }
